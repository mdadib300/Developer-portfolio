...
const Banner = () => {
    return (
        <div className="m-5 md:pt-10 text-white">
            <div className="flex flex-col lg:flex-row-reverse items-center justify-around">
                ...
                <div>
                    <h1 className="text-5xl font-semibold mb-5">
                        <span className='text-primary'>MD ADIB</span> CHOWDHURY
                    </h1>
                    ...
                    <a href='https://drive.google.com/file/d/1Yb-aMJrPcwWfGzsv3gEQTAJergoz6DFq/view?usp=share_link' target='blank' className="myBtn mr-5">Resume</a>
